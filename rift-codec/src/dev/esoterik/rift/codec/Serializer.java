...
public interface Serializer {
  ...
  @Nullable
  @Contract("null -> null; !null -> !null")
  default <V> String serialize(@Nullable final V value) throws SerializerException {
  ...
  @Nullable
  @Contract("null -> null; !null -> !null")
  default <V> V deserialize(@Nullable final String payload) throws SerializerException {
