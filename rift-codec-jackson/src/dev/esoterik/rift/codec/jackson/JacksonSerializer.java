...
import dev.esoterik.rift.codec.SerializerException;
...
public final class JacksonSerializer implements Serializer {
   ...
   */
  @Contract(pure = true)
  JacksonSerializer(final @NotNull ObjectMapper objectMapper) {
   ...
   */
  @Override
  public @Nullable String serializeRaw(final @Nullable Object value) throws SerializerException {
    if (value == null) {
      return null;
    }
   ...
   */
  @Override
  public <V> @Nullable V deserializeRaw(final @Nullable String payload) throws SerializerException {
    if (payload == null) {
      return null;
    }
  ...
  public @Nullable <V> String serialize(final @Nullable V value) throws SerializerException {
  ...
  @Override
  @Contract("null -> null; !null -> !null")
  public @Nullable <V> V deserialize(final @Nullable String payload) throws SerializerException {
    if (payload == null) {
      return null;
    }
