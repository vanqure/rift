...
public final class JacksonSerializerFactory {
    ...
    public static @NotNull JacksonSerializer create(@NotNull ObjectMapper objectMapper) {
    ...
    public static @NotNull JacksonSerializer create(@NotNull ClassLoader classLoader) {
        ObjectMapper mapper = createObjectMapper();
